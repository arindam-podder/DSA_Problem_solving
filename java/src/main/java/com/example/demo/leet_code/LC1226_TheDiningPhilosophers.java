...
The philosophers' ids are numbered from 0 to 4 in a clockwise order. Implement the function void wantsToEat(philosopher, pickLeftFork, 
...
public class LC1226_TheDiningPhilosophers {

}


//0-4 total 5 philosopher so forn 0-4 , id-0 , left fork is 0 and right fork is 1 ..... id-4 left is 4 and right 0 , 
//so do mod for right fork - fork%id
class DiningPhilosophers {
    ...
    public DiningPhilosophers() {
        ...
        //by defaulit all fork sema has one permit ,  
        for(int i=0; i<5; i++) {
        	locks[i] = new ReentrantLock();
        }
        
        philoSema = new Semaphore(4);   //only 4 permit to avoid deadlock 
    }
