/*
 * Q1. Tower of Hanoi  (day 47 - 17 july 2023- recursion)
...
public class TowerOfHanoi {
	...
	public static void main(String[] args) {
		...
		TOHRecusion(list, totalDisk, source, auxilary, destination);
	...
	public static void TOHRecusion(ArrayList<ArrayList<Integer>> list, int A, int source, int auxilary, int destination) {
		if(A==0) return;
		
		TOHRecusion(list, A-1, source, destination, auxilary);
		...
		TOHRecusion(list, A-1, auxilary, source, destination);
