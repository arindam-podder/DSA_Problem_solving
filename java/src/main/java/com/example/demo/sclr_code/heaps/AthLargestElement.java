...
public class AthLargestElement {
	...
	public static void main(String[] args) {
		List<Integer> arr = List.of(15, 20, 99, 1);
		int b = 2;

		System.out.println( athLargestInSubArrays(b, arr) );
	}
	
	public static ArrayList<Integer> athLargestInSubArrays(int A, List<Integer> B) {
