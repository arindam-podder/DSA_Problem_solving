...
and put the remaining candies in the other box that has the minimum number of candies. Misha does not like a box if 
it has the number of candies greater than B so she won't eat from that box. Can you find how many candies she will eat?
...
public class MishaAndCandies {
	...
	public static int eatenCandy(ArrayList<Integer> A, int B) {
