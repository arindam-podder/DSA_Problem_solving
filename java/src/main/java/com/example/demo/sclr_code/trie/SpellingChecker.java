...
You have to return the binary array (of length |B|) as the answer where 1 denotes that the word is present in the dictionary 
and 0 denotes it is not present.
...
import com.example.demo.sclr_code.trie.WordDictionary.TrieNode;

public class SpellingChecker {

	public static void main(String[] args) {
		
		TrieNode trieNode = WordDictionary.createDict(new String[] {"arin", "pod", "podder", "good", "bad"});
		System.out.println(WordDictionary.isWordPresent(trieNode, "pod"));
	}
