...
public class MinimumNumberOfSquare_dp {

	public static void main(String[] args) {
		
		//System.out.println( solutionWithRecur(7168) );
		//System.out.println( solutionWithMemorization(8285) );
		
		//System.out.println( recur(8285) );
		System.out.println( recurMemorization(8285) );
		System.out.println( tabulationBottomUp(8285) );
	}
